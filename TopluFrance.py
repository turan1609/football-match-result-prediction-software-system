...
base_url = "https://www.mackolik.com/kupa/fransa-ligue-1/{}/fikstur/dm5ka0os1e3dxcp3vh05kmp33"

with open("mac_verilerifrance.csv", "w", newline='', encoding="utf-8") as csvfile:
    csvwriter = csv.writer(csvfile)
    csvwriter.writerow(["Ligue 1"])
