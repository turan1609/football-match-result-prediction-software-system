...
base_url = "https://www.mackolik.com/kupa/ingiltere-premier-lig/{}/fikstur/2kwbbcootiqqgmrzs6o5inle5"

with open("mac_verileriengland.csv", "w", newline='', encoding="utf-8") as csvfile:
    
    csvwriter = csv.writer(csvfile)
    
    csvwriter.writerow(["Premier Lig"])
