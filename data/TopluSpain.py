...
sezonlar = range(2000, 2024)  # 2000-2001 sezonundan 2023-2024 sezonuna kadar

base_url = "https://www.mackolik.com/kupa/ispanya-laliga/{}/fikstur/34pl8szyvrbwcmfkuocjm3r6t"

with open("mac_verilerispain.csv", "w", newline='', encoding="utf-8") as csvfile:
    csvwriter = csv.writer(csvfile)
    csvwriter.writerow(["La Liga"])
