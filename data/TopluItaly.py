...
base_url = "https://www.mackolik.com/kupa/italya-serie-a/{}/fikstur/1r097lpxe0xn03ihb7wi98kao"

with open("mac_verileriitaly.csv", "w", newline='', encoding="utf-8") as csvfile:
    csvwriter = csv.writer(csvfile)
    csvwriter.writerow(["Serie A"])
