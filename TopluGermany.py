...
base_url = "https://www.mackolik.com/kupa/almanya-bundesliga/{}/fikstur/6by3h89i2eykc341oz7lv1ddd"

with open("mac_verilerigermany.csv", "w", newline='', encoding="utf-8") as csvfile:
    csvwriter = csv.writer(csvfile)
    csvwriter.writerow(["Bundesliga"])
